...
<div id="tc_switch_to_lists" class="button">Switch to Lists</div>
<div id="circle_type" style="display:none">loop</div>

<div id="loop_list_instructions">Drag your connections into Loops -></div>
...
<div id="circle_ui_content" class="container_24">
	...
	<div class="friendboxes grid_15 alpha" id="friendboxes">
		<div id="switch_to_lists" class="button">Switch to Lists</div>
...
<div id="newcircle_form">
	<label id="newcircle_circlenamelabel">Loop name
		<input type="text" size="15" id="newcircle_circlename">
	</label>
	<div id="newcircle_member">
	</div>
	<div id="newcircle_button">
		<button id="newcircle_creation">Create new Loop</button>
...
<div id="edit_form">
	<label id="edit_circlenamelabel">Loop name
		<input type="text" size="15" id="edit_circlename">
	</label>
	<div id="edit_circle_button">
		<button id="edit_changename">Change Loop name</button>
...
$(function() {
	...
	$('#tc_switch_to_lists').live('click', function() {
		window.location = '<?=base_url()?>/tc_lists';
	});
});
