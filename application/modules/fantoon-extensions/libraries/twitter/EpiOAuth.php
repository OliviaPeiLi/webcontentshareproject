...
class EpiOAuth
{
  ...
  public function getAuthorizationUrl($oauth_callback = NULL)
  {  
    $retval = "{$this->authorizeUrl}?";
    $token = $this->getRequestToken($oauth_callback);
    //print_r($this->authorizeUrl);
    return $this->authorizeUrl . '?oauth_token=' . $token->oauth_token;
  }

  public function getRequestToken($oauth_callback = NULL)
  {
  	//print_r($this->requestTokenUrl);
  	if ($oauth_callback) {
  		$resp = $this->httpRequest('GET', $oauth_callback);
  	} else {
