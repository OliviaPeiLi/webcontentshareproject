...
--
-- Host: localhost
-- Generation Time: Jun 11, 2012 at 04:56 PM
...
CREATE TABLE IF NOT EXISTS `activities` (
  ...
  KEY `type` (`type`),
  KEY `time` (`time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14191 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2238 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9280 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=621488 ;
...
CREATE TABLE IF NOT EXISTS `folder_user` (
  ...
  KEY `user_id` (`user_id`),
  KEY `folder_id` (`folder_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4210 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11550 ;
...
CREATE TABLE IF NOT EXISTS `newsfeed` (
  ...
  KEY `folder_id` (`folder_id`),
  KEY `time` (`time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12783995 ;
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  PRIMARY KEY (`page_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1226 ;
