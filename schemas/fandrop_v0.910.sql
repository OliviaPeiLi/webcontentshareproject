...
--
-- Host: localhost
-- Generation Time: Jul 11, 2012 at 08:53 PM
...
CREATE TABLE IF NOT EXISTS `activities` (
  ...
  KEY `type` (`type`),
  KEY `time` (`time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=22017 ;
...
CREATE TABLE IF NOT EXISTS `beanstalk_jobs` (
  ...
  KEY `job_id` (`job_id`),
  KEY `type` (`type`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5827 ;
...
CREATE TABLE IF NOT EXISTS `connections` (
  ...
  KEY `user1_id` (`user1_id`),
  KEY `user2_id` (`user2_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1893 ;
...
CREATE TABLE IF NOT EXISTS `custom_tabs` (
  ...
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`tab_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1980 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=623782 ;
...
CREATE TABLE IF NOT EXISTS `folder_user` (
  ...
  KEY `user_id` (`user_id`),
  KEY `folder_id` (`folder_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11813 ;
...
CREATE TABLE IF NOT EXISTS `likes` (
  ...
  KEY `link_id` (`link_id`),
  KEY `comment_id` (`comment_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3175 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=14929 ;
...
CREATE TABLE IF NOT EXISTS `lists` (
  ...
  `time` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`list_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1917 ;
...
CREATE TABLE IF NOT EXISTS `loops` (
  ...
  PRIMARY KEY (`loop_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3143 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12788156 ;
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  KEY `a_id` (`a_id`),
  KEY `m_id` (`m_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6015 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=8049 ;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=371765 ;
