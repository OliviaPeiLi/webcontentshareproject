...
--
-- Host: localhost
-- Generation Time: Jul 28, 2012 at 04:24 PM
...
CREATE TABLE IF NOT EXISTS `activities` (
  ...
  KEY `type` (`type`),
  KEY `time` (`time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=24005 ;
...
CREATE TABLE IF NOT EXISTS `beanstalk_jobs` (
  ...
  KEY `job_id` (`job_id`),
  KEY `type` (`type`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=19818 ;
...
CREATE TABLE IF NOT EXISTS `connections` (
  ...
  KEY `user1_id` (`user1_id`),
  KEY `user2_id` (`user2_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2624 ;
...
CREATE TABLE IF NOT EXISTS `email_settings` (
  ...
  `collaboration` enum('1','0') NOT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3135 ;
...
CREATE TABLE IF NOT EXISTS `facebookusers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1584 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=39820 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5398 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=624152 ;
...
CREATE TABLE IF NOT EXISTS `folder_user` (
  ...
  KEY `user_id` (`user_id`),
  KEY `folder_id` (`folder_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=18297 ;
...
--
-- Table structure for table `gmail_invites`
--

CREATE TABLE IF NOT EXISTS `gmail_invites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4218 ;
...
CREATE TABLE IF NOT EXISTS `likes` (
  ...
  KEY `link_id` (`link_id`),
  KEY `comment_id` (`comment_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3300 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=15444 ;
...
CREATE TABLE IF NOT EXISTS `loops` (
  ...
  PRIMARY KEY (`loop_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3223 ;
...
CREATE TABLE IF NOT EXISTS `newsfeed` (
  ...
  `is_ranked` tinyint(3) unsigned NOT NULL,
  `ranked_at` datetime NOT NULL,
  `hits` bigint(20) NOT NULL DEFAULT '0',
  `complete` enum('1','0') NOT NULL,
  `uniqview` bigint(20) NOT NULL DEFAULT '0',
  `fb_share_count` int(11) NOT NULL DEFAULT '0',
  `orig_user_id` int(11) NOT NULL DEFAULT '0',
  ...
  KEY `folder_id` (`folder_id`),
  KEY `time` (`time`),
  KEY `orig_user_id` (`orig_user_id`),
  KEY `is_ranked` (`is_ranked`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12789159 ;
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  KEY `a_id` (`a_id`),
  KEY `m_id` (`m_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7373 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=8482 ;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `auto_share` enum('1','0') NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=371845 ;
...
CREATE TABLE IF NOT EXISTS `user_stats` (
  ...
  `signup_type` varchar(32) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
