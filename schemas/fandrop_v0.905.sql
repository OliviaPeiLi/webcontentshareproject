...
--
-- Host: localhost
-- Generation Time: Apr 30, 2012 at 11:34 PM
...
CREATE TABLE IF NOT EXISTS `activities` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6815 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=56954 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4327 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1347 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5370 ;
...
CREATE TABLE IF NOT EXISTS `newsfeed` (
  ...
  KEY `type` (`type`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6055 ;
...
CREATE TABLE IF NOT EXISTS `sending_emails` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=946 ;
