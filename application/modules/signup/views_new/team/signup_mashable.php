...
<div id="universitySignup_wrapper" class="mashable">
	<div id="topBox">
		...
		<div class="signup_content">
			...
			<div class="universitySignup_bottom">
				<div class="universitySignup_title">
					<span class="universitySignup_titleText">Mashable</span>
				</div>
				...
				<? /* ?><a href="/leaderboard/superbowl" class="signupLeaderboard_link">Mashable Leaderboard</a><? */ ?>
				<div id="signup_social_wrapper">
					...
					<iframe class="universitySignupFB_facepile" src="http://www.facebook.com/plugins/facepile.php?size=small&app_id=<?=$this->config->item('fb_app_key')?>&amp;colorscheme=dark" scrolling="no" frameborder="0" allowTransparency="true" width="610" max_rows="1"></iframe>
				</div>
			</div>
