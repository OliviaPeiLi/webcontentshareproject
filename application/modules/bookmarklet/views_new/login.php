		...
		<?=Form_Helper::open('bookmarklet/external_login', array('id'=>'bookmarklet_login_form'))?>
			...
			<span class="loginRight">
				<span class="emailPassword">
					...
					<div class="form_row">
						<?=Form_Helper::password('password', '', array('placeholder'=>$this->lang->line('bookmarklet_pass_ph'), 'id'=>"login_password"))?>
					</div>
					<div class="form_row">
						<a href="/forgotpassword" target="_blank" class="forgotPass">Forgot password?</a>
					</div>
				</span>
				<span class="loginButton">
					<div class="form_row login">
						<?php echo Form_Helper::submit('submit', $this->lang->line('bookmarklet_submit_ph'), array('id'=>"login_submit", 'class'=>"blue_btn"))?>
					</div>
				</span>
			</span>			
		<?=Form_Helper::close()?>
