...
--
-- Host: localhost
-- Generation Time: May 12, 2012 at 04:16 PM
...
CREATE TABLE IF NOT EXISTS `activities` (
  ...
  KEY `type` (`type`),
  KEY `time` (`time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=11921 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=17188 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9889 ;
...
CREATE TABLE IF NOT EXISTS `newsfeed` (
  ...
  KEY `folder_id` (`folder_id`),
  KEY `time` (`time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10945 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5132 ;
