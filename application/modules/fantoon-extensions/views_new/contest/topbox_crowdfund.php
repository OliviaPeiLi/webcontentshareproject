<div class="demo_topBox" style="padding-bottom: 10px; margin: 20px auto 15px;">
	<h2>Contest Prizes</h2>
	<ul class="contestPrize_list">
		<li style="display:none;"></li>
		<li class="contestPrize_item">Bragging rights as the first ever Crowdfunder Champ.</li>
	</ul>
	<h2>How It Works</h2>
	<div class="contest-blurb">
		<ul class="contestPrize_list">
			<li class="contestPrize_item">Each startup gets points for views and shares they receive from their fans. Each unique view = 1 point. Each tweet = 10 points.</li>
			<li><small>*please note: points from views are verified and do not appear immediately.</small></li>
		</ul>
	</div>
	<? /* ?>
	<h2> About Founders Network</h2>
	<div class="contest-blurb">
		<ul class="contestPrize_list">
			<li class="contestPrize_item">
				Founded in 2011, Founders Network is a peer mentorship organization of more than 350 
				tech startup “founders helping founders” whose members help each other efficiently 
				solve startup problems through a private member site and in-person meetings in San 
				Francisco, Silicon Valley, Los Angeles and New York City. All members are vetted 
				through an approval process that only admits experienced founders who expressly commit
				to the success of the group. For more information, please visit 
				<a href="http://www.foundersnetwork.com" target="_blank">http://www.foundersnetwork.com</a>
			</li>
		</ul>
	</div>
	<? */ ?>
