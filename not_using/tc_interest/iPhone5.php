...
<head>
	...
	<link rel="stylesheet" href="CSS/style_demo.css" type="text/css" media="screen" />
	...
	<script src="http://dmitry.fandrop.com/js/custom.js" type="text/javascript" charset="utf-8"></script>
...
<body>
    <div id="header">
            ...
            <div class="container_24">
                <h1>
                    <a href="javascript:;" title="">Fandrop</a>
                                ...
                                <div id="hdr_account">
                	<div id="account_menu" class="account_menu inlinediv menu_caller" onmousedown="javascript:view_hide('options');">
		                    ...
		                    <a href="javascript:;" title="" id="account_link">
		                    	<div id="account_name" class="inlinediv">Stefani Germanotta</div> 
					...
					<div id="account_options">
						<ul id="options" class="menu">
															<li><a href="/personal_info/my_info">Personal Info</a></li>
								<li><a href="/account_options">Account Settings</a></li>								 
            ...
            <ul id="headerLinks" class="headerLinks">
                                        ...
                                        <li class="hdrnav_item"><a href="/discover_interests/1" title="">What's Hot</a> | </li>
																<li class="hdrnav_item"><a href="/profile/Stefani-Germanotta/396" id="hdrnav_profile">Profile</a></li>
					                            </ul>
        </div>
...
<input type="hidden" name="ci_csrf_token" value="87ad4dcaa00f5bf3d6e5464296df0b72" />
</div>						<input type="text" name="search_input" value="Search" id="header_search_box" class="box_input_placeholder" />						<button type="submit" id="searchButton" class="search_button">Search</button>
						</form>					</label>
				...
				<ul class="headerIcons">
				    <li class="hdrnav_item2 menu_caller hdr_graph"><a class="graph"></a></li>
				    <li class="hdrnav_item2 menu_caller hdr_link"><a class="link"></a></li>
				</ul>
				<ul class="headerIcons">
				    <li class="hdrnav_item hdr_allfriends menu_caller" id="hdr_allfriends" onclick="markread('request')"; onmousedown="javascript:view_hide('requests');">
				    ...
				    <li class="hdrnav_item hdr_notifications menu_caller" id="hdr_notifications" onclick="read_notification('number')" onmousedown="javascript:view_hide('notifications');">
					...
					<ul>
					    ...
					    <li class="nohover">
						<a href="/show_all">See All Notifications</a>
					    </li>
					</ul>
				    </div>
				    <li class="hdrnav_item hdr_msgs" id="hdr_msgs" onclick="javascript:go('/message');";>
					<a href="javascript:;" title="" class="message">Message</a>
				    </li>
				</ul>

                <!--
                				<div id="account_menu" class="account_menu inlinediv menu_caller">
					<div class="account_link unselectable" onmousedown="javascript:view_hide('options');">
					
																				<div id="account_avatar" class="inlinediv"><img src="https://s3.amazonaws.com/fantoon-dev/users/396/pics/thumbs/thumb.jpg" /></div>
							<div id="account_name" class="inlinediv">Stefani</div>
												
						<div id="account_arrow" class="inlinediv"><div class="dropdown_menu_arrow"></div></div>
					</div>
					<div id="account_options">
						<ul id="options" class="menu">
															<li><a href="/personal_info/my_info">Personal INFO</a></li>
                ...
                <div class="interests_container">
                	<div id="page_misc_info">
						...
						<div id="topics_area">
								...
								Topics: 
								<li class="page_topic">
								    <a href="/topic/50">Tech</a>
								</li>
								<li class="page_topic">
								    <a href="/topic/96">Brands</a>
								</li>
								<li class="page_topic">
								    <a href="/topic/96">Phones</a>
								</li>
								<li class="page_topic">
								    <a href="/topic/96">Cupertino</a>
								</li>
								<li class="page_topic">
								    <a href="/topic/96">Steve Jobs</a>
								</li>
															</ul>
														<div id="add_page_topic" class="inlinediv"><a>Add Topic</a></div>									<div id="lock_topics" class="inlinediv">
										<a href="/topic_lock/2662/1">Lock topics</a>
									</div>
...
<div class="hidden">
<input type="hidden" name="ci_csrf_token" value="87ad4dcaa00f5bf3d6e5464296df0b72" />
</div><input type="text" name="topic_id" value="" id="load_topics" /><input type="hidden" id="topic_names" name="topic_name" /><input type="hidden" name="redirect_url" value="http://dmitry.fandrop.com/interests/Madonna/2662"/><input type="submit" name="submit" value="Submit" id="page_new_topic_submit" /></form>								</div>
														<script type="text/javascript">
						...
						<div id="feature_interests_area">
																						<div id="add_feature_interest" class="inlinediv"><a>Add Feature Interests</a></div>
																					<div id="apply_alias" class="inlinediv"><a>Add Alias</a></div>														
...
<div class="hidden">
<input type="hidden" name="ci_csrf_token" value="87ad4dcaa00f5bf3d6e5464296df0b72" />
</div><input type="text" name="alias" value="Enter new alias" class="input_placeholder" /><input type="hidden" name="url" value="http://dmitry.fandrop.com/interests/Madonna/2662" /><input type="submit" name="submit" value="Submit" id="page_new_alias_submit" /></form>							</div>
...
<div class="hidden">
<input type="hidden" name="ci_csrf_token" value="87ad4dcaa00f5bf3d6e5464296df0b72" />
</div><input type="text" name="page" value="Enter feature interests" class="input_placeholder" /><input type="hidden" name="url" value="http://dmitry.fandrop.com/interests/Madonna/2662" /><input type="submit" name="submit" value="Submit"  /></form>							</div>
						</div>
					
						<div id="page_topics_other_pages">
							<div id="page_topics_placeholder" class="grid_9 alpha">
							...
							<div id="page_otherpages_placeholder" class="grid_8 omega">
								<div id="page_otherpages">
									<!--TODO: find a resource and populate -->
								</div>
							</div>
						</div>
					</div>
	                    ...
	                    <div class="interests_tabs" id="page_tabs_row">
	                        <ul>
	                            <li id="wall_tab" class="page_tab"><a href="/interests/Madonna/2662">Channel</a></li>
	                            <li id="events_tab" class="page_tab"><a href="/events/2662">Events</a></li>
	                            <li id="info_tab" class="page_tab"><a href="/page_info/2662">Info</a></li>
	                            <li id="photos_tab" class="page_tab"><a href="/photo_albums/2662/page/">Photos</a></li>
	                            <li id="videos_tab" class="page_tab"><a href="#">Videos</a></li>
	                            <li id="pr_tab"><a href="/pr_page/2662">PR</a></li>
	               												<li id="more_tabs" class="page_tab" style="display:none" onclick="javascript:open_tab_menu()"><a href="#">More…</a></li>
	               								<li id="add_new_tab"><a href="#" onclick="return false" onmousedown="javascript:view_hide('tabs');">+</a></li>								<ul style="display:none" id="more_tabs_list" class="menu site_menu"></ul>
	                        </ul>
...
<div class="hidden">
<input type="hidden" name="ci_csrf_token" value="87ad4dcaa00f5bf3d6e5464296df0b72" />
</div>Tab Name<input type="text" name="tab_name" value=""  /><input type="submit" name="submit" value="Submit"  /></form>							</div>
	                    </div>
				...
				<div id="box">
					...
					<div class="thread_body inlinediv">
						...
						<a href="">Holographic screen??</a>
					    </div>
					    <div class="body">
						<a href="/view_msg/26">This has got to be the real reason for delay.  Why else...</a>
					    </div>
					    <div class="user_name">
						<a href="/profile/Cherilyn-Sarkisian/2">Cherilyn Sarkisian</a>
					    </div>
					</div>
					<div class="timestamp inlinediv">20 minutes ago</div>
					<div class="replies inlinediv">1,000,000</div>
					<div class="views inlinediv">203,929,034</div>
				    </div>
				    <div class="topic_thread">
					<div class="thread_body inlinediv">
					    <div class="topic_name">
						<a href="">Laser Keyboard?</a>
					    </div>
					    <div class="body">
						<a href="/view_msg/26">What if this is the new big feature?</a>
					    </div>
					    <div class="user_name">
						<a href="">Arthur Dent</a>
					    </div>
					</div>
					...
					<div class="thread_body inlinediv">
					    <div class="topic_name">
						<a href="">It has alien technology...</a>
					    </div>
					    <div class="body">
						<a href="/view_msg/26">Ever notice how it's always thinner than other phones?</a>
					    </div>
					    <div class="user_name">
						<a href="/profile/Cherilyn-Sarkisian/2">Montgomery Scott</a>
					    </div>
					</div>
					...
					<div class="thread_body inlinediv">
					    <div class="topic_name">
						<a href="">Carved from 1 block of aluminum<a>
					    </div>
					    <div class="body">
						<a href="/view_msg/26">Wouldn't it be awesome if this was how it was made?</a>
					    </div>
					    <div class="user_name">
						<a href="/profile/Cherilyn-Sarkisian/2">Johnny Fife</a>
					    </div>
					</div>
					<div class="timestamp inlinediv">4 hours ago</div>
					<div class="replies inlinediv">555</div>
					<div class="views inlinediv">900</div>
				    </div>
				</div>
				<ul>
				    
				<div id="page_newsfeed" class="newsfeed_placeholder newsfeed">
...
<!--<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js" type="text/javascript" charset="utf-8"></script>-->
    ...
    <li class="profile_newsfeed_entry newsfeed_text_entry newsfeed_entry newsfeed_border_top demo_width">
            		
	    	    	    	<span class="up_rank"><strong class="num_ups">1</strong><a href="/like/104/link//104/1547/page" title="">Up_Count</a></span>
	    	    
	            <div class="inlinediv show_badge newsfeed_entry_avatar_page page_avatar">
        	<a href="http://dmitry.fandrop.com/interests/Madonna/2662">
        		<img class="newsfeed_avatar_img" src="https://s3.amazonaws.com/fantoon-dev/pages/2662/pics/thumbs/thumb.jpg"/>
           	</a>
        	<div style="display:none;" class="obj_id">2662</div>
        </div>
                <a href="javascript:;" title=""><a href="/interests/Madonna/2662">David Stone</a></a>
        <small>5 days ago</small>
        <p class="post_content">The latest word on the street is...</p>
        <!--~~~~~~~~ List of Likes ~~~~~~~~~-->
        <!--~~~~~~~~ List of Likes ~~~~~~~~~-->

<!--~~~~~~~~ List of Comments ~~~~~~-->
<p class="like_text"><a href="/profile/Cherilyn-Sarkisian/2">Cherilyn Sarkisian</a> ups this.</p>
        <div class="clear"></div>
                <div class="link_post">
            <div class="info link_info">
                <div class="title">
                    <a href="http://www.engadget.com/2011/07/07/iphone-5-4s-the-rumor-roundup/">iPhone 5 / 4S: the rumor roundup - Engadget</a>
                </div>
                <div class="desc">
                                    </div>
            </div>
            <div class="image link_image">
                <img src="http://www.blogcdn.com/www.engadget.com/media/2011/06/wwdc-11-ios5-camera-01.jpg" style="max-width:260px;vertical-align:top">
            </div>
        </div>
        <!--~~~~~~~~~~~~~~~~~ Comments Options (Up, add comment, etc..) ~~~~~~~~~~~~~~~~~-->
        <div class="rate newsfeed_entry_options">
                            
                                <a class="up up_button"  href="/like/104/link//104/1547/page">UP</a>
                <a class="up undo_up_button" style="display:none" href="/del_like/396/link/1547/104/page/">Undo UP</a>

                        		<a href="" class="add newsfeed_entry_add_comment_lnk" onclick="setTo('104', 'link', '2662', '2662')">Add comment</a> |
    		    		            <a class="hide newsfeed_view_comments_lnk" rel="3" href="">Hide Comments (3)</a>
        </div>
        <!--~~~~~~~~ List of Comments ~~~~~~-->
        <div class="newsfeed_entry_comments"> <!-- contains comments -->
			<div class="newsfeed_entry_comment">
			<div class="newsfeed_entry_comment_avatar inlinediv show_badge page_avatar">
				<a href="#"><img class="newsfeed_comment_avatar_img" src="https://s3.amazonaws.com/fantoon-dev/users/1/pics/thumbs/thumb.jpg"></a>
				<div style="display:none;" class="obj_id">1</div>
			</div>
			<div>
				<span class="user_name">
					<a href="/profile/Alexi-Ned/1">Alexi Nederer</a>				</span>
				<span class="newsfeed_time">5 days ago</span>			</div>
						<p class="comment_content">
				Awesome!							    							</p>
            <!--~~~~~~~~ List of Likes ~~~~~~~~~-->

<!--~~~~~~~~ List of Comments ~~~~~~-->
<p class="like_text"><a href="/profile/Alexi-Ned/1">Alexi Nederer</a> ups this.</p>
							<div class="newsfeed_entry_comment_options">
					                                                    <a class="up up_button"  href="/like/508/link_comm/2662/104/1547/page">UP</a>
                                                <a class="up undo_up_button" style="display:none" href="/del_like/396/photo_comm/1547/508/page/2662">Undo UP</a>
                                                        </div>
			            <div class="clear"></div>
		</div>
        <div class="clear"></div>
		<div class="newsfeed_entry_comment indent_1">
			<div class="newsfeed_entry_comment_avatar inlinediv show_badge page_avatar">
				<a href="#"><img class="newsfeed_comment_avatar_img" src="https://s3.amazonaws.com/fantoon-dev/users/4/pics/thumbs/thumb.jpg"></a>
				<div style="display:none;" class="obj_id">1</div>
			</div>
			<div>
				<span class="user_name">
					<a href="/profile/Alexi-Ned/1">Ray Xu</a>				</span>
				<span class="newsfeed_time">5 days ago</span>			</div>
						<p class="comment_content">
				Impressive!								    							</p>
            <!--~~~~~~~~ List of Likes ~~~~~~~~~-->
...
<!--~~~~~~~~ List of Comments ~~~~~~-->
							...
							<div class="newsfeed_entry_comment_options">
					                                                    <a class="up up_button"  href="/like/509/link_comm/2662/104/1547/page">UP</a>
                                                <a class="up undo_up_button" style="display:none" href="/del_like/396/photo_comm/1547/509/page/2662">Undo UP</a>
                                                        </div>
			            <div class="clear"></div>
		</div>
        <div class="clear"></div>
		<div class="newsfeed_entry_comment indent_1">
			...
			<div>
				...
				<span class="newsfeed_time">5 days ago</span>			</div>
						<p class="comment_content">
				A lot of interesting thoughts.  Many of them are just rumours.								    							</p>
            <!--~~~~~~~~ List of Likes ~~~~~~~~~-->

<!--~~~~~~~~ List of Comments ~~~~~~-->

							<div class="newsfeed_entry_comment_options">
					                                                    <a class="up up_button"  href="/like/510/link_comm/2662/104/1547/page">UP</a>
                                                <a class="up undo_up_button" style="display:none" href="/del_like/396/photo_comm/1547/510/page/2662">Undo UP</a>
                                                        </div>
			            <div class="clear"></div>
		</div>
        <div class="clear"></div>
	<!--~~~~~~~~~~~~~~ Post a comment ~~~~~~~~~~~~~~~~~~~-->
			 <div class="newsfeed_entry_add_comment" style="display: block;">
						<form action="http://dmitry.fandrop.com/comment" method="post" accept-charset="utf-8">
<div class="hidden">
<input type="hidden" name="ci_csrf_token" value="87ad4dcaa00f5bf3d6e5464296df0b72" />
</div>			
<input type="hidden" name="uri_name" value="Madonna" />

			<b id="reply_link_104"> </b>
			<b id="reply_type_link_104"> </b>
			<b id="to_link_104"> </b>

									
			
<input type="hidden" name="to" value="2662" />

			
<input type="hidden" name="page_type" value="interests" />
			
<input type="hidden" name="loop_id" value="" />
			
<input type="hidden" name="comm_type" value="link_comm" />
			
<input type="hidden" name="link_id" value="104" />
			
<input type="hidden" name="newsfeed_id" value="1547" />
			<div class="comment_input_container">
				<input type="text" name="comm_msg" value="" class="reply_comm" />			</div>
			<div class="comment_submit_container">
				<input type="submit" name="submit" value="Comment" class="comment_submit" />			</div>
			</form>		</div>
...
<!--<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js" type="text/javascript" charset="utf-8"></script>-->
	...
	<li class="profile_newsfeed_entry newsfeed_text_entry newsfeed_entry newsfeed_border_top demo_width">
	    	    	    	...
	    	    	    	<span class="up_rank"><strong class="num_ups">0</strong><a href="/like/592/post/2662/592/1545/page" title="">Up_Count</a></span>
	    		
        <div class="inlinediv show_badge newsfeed_entry_avatar_user user_avatar">
        	<a href="http://dmitry.fandrop.com/profile/Alexi-Ned/1">
        		<img class="newsfeed_avatar_img" src="https://s3.amazonaws.com/fantoon-dev/users/1/pics/thumbs/thumb.jpg">
           	</a>
        	<div style="display:none;" class="obj_id">1</div>
        </div>
	    <a href="/profile/Alexi-Ned/1">Alexi Nederer</a>	    <small>5 days ago</small>
	    	    	
	    <p class="post_content">I'm selling my 4G when this thing comes out!</p>
	    <!--Add Ups here -->
	    <!--~~~~~~~~ List of Likes ~~~~~~~~~-->
	    <!--~~~~~~~~ List of Likes ~~~~~~~~~-->
...
<!--~~~~~~~~ List of Comments ~~~~~~-->
	    		...
	    		<div class="rate newsfeed_entry_options">
					            	                ...
					            	                <a class="up up_button"  href="/like/592/post/2662/592/1545/page">UP</a>
	                <a class="up undo_up_button" style="display:none" href="/del_like/396/post/1545/592/page/2662">Undo UP</a>
	            	            	            <a href="" class="add newsfeed_entry_add_comment_lnk" onclick="setTo('592', 'post', '2662', '1')">Add comment</a>
								        <a class="hide newsfeed_view_comments_lnk" rel="0" href="javascript:;" title="">Hide Comments (0)</a>
...
<input type="hidden" name="uri_name" value="Madonna" />
			...
			<b id="reply_post_592"> </b>
			<b id="reply_type_post_592"> </b>
			<b id="to_post_592"> </b>
...
<input type="hidden" name="comm_type" value="post_comm" />
			
<input type="hidden" name="post_id" value="592" />
			
<input type="hidden" name="newsfeed_id" value="1545" />
			<div class="comment_input_container">
				<input type="text" name="comm_msg" value="" class="reply_comm" />			</div>
			<div class="comment_submit_container">
				<input type="submit" name="submit" value="Comment" class="comment_submit" />			</div>
            ...
            <div id="profile_info" class="grid_6 omega">
                <div class="profile_pic">
                    ...
                    <div id="page_profilePic">
                        <a href="#" id="link_to_edit_photo" >Change Profile Picture</a><a href="/view_profile_photos/2662?type=page" id="link_to_profile_album"><img src="http://bindapple.com/wp-content/uploads/2010/08/how-much-does-the-new-iphone-cost2.png" id="page_pic_auth"/></a>                        <div class="clear"></div>
                    </div>
                    <div class="profile_interests">
	                            ...
	                            <dt><em>Your Connections:</em></dt>
										...
										<div class="avatar inlinediv show_badge user_avatar badge_left"style="float: left;">
											...
											<div class="obj_id" style="display:none;">1</div>
                                                                            ...
                                                                            <a id="page_admin_link" style="display:none;" href="/set_admin/2662/1">make admin</a>
                                                                                                                    <a id="page_admin_link" style="display:none;"href="/rm_user/2662/1"> remove user</a>
                                                                            									                        </dl>
                                                <dl>
                        ...
                        <div class="clear"></div>
                            	...
                            	<dt><em>
                                 	...
                                 	<dd class="user_avatar avatar inlinediv show_badge badge_left">
                                 		<a href="/profile/Cherilyn-Sarkisian/2" title="">
                                 			<div class="img_tight_wrapper">
                                 		...
                                 		<div class="obj_id" style="display:none;">2</div>
                                                                                    <a id="page_admin_link" style="display:none;" href="/set_admin/2662/2">make admin</a>
...
<div id="add_people_to_interest" style="display:none;">
    ...
    <div class="desc">
        Madonna has been added to your list of interests.
    </div>
    <div class="desc">
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var tabs_width_limit = $('#page_tabs_row > ul').width()-$('#add_new_tab').width()-$('#more_tabs').width()-60;
        ...
        $('#add_feature_interest').live('click', function() {
            if ($('#new_feature').css('display') === 'none')
                $('#new_feature').show('blind');
            else
                $('#new_feature').hide('blind');
        });

    });
/*
	//Code to deal with profile page post tabs (Post/Photo)
	$('.page_post_tab').live('click', function() {
		if ($(this).attr('id') === 'page_post_tab_post') {
			$('#page_upload_photo').css('display','none');
			$('#page_add_post').css('display','block');
			$(this).parent().find('.active_post_tab').removeClass('active_post_tab');
			$(this).addClass('active_post_tab');
		}
		else if ($(this).attr('id') === 'page_post_tab_photo') {
			$('#page_add_post').css('display','none');
			$('#page_upload_photo').css('display','block');
			$(this).parent().find('.active_post_tab').removeClass('active_post_tab');
			$(this).addClass('active_post_tab');
		}
		return false;
...
*/
	...
	/*
	$('.page_tab').live('click', function() {
		var segments = (window.location.pathname).split('/');
		var baseurl = window.location.host;
		var ajax_load = "Loading...";
		
		if ($(this).attr('id').indexOf('custom_tab') >= 0) {
			window.location.replace('$(this).find('a').attr('href'));
			//$('#page_tab_maincontent').html(ajax_load).load($(this).find('a').attr('href'),'header=none');
		}	
		switch($(this).attr('id'))
		{
		case 'wall_tab':
			window.location.replace('http://'+baseurl+'/index.php/page/index/'+segments[4]);
			break;
		case 'events_tab':
			window.location.replace('http://'+baseurl+'/index.php/page/index/'+segments[4]);
			//$('#page_tab_maincontent').html(ajax_load).load($(this).find('a').attr('href'),'header=none');
