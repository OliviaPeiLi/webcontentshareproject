...
<div id="universitySignup_wrapper" class="vDay">
		...
		<div class="signup_content">
			...
			<div class="universitySignup_bottom">
				<div class="universitySignup_title">
					<span class="universitySignup_titleText">Valentine's Day</span>
				</div>
				...
				<div id="signup_social_wrapper">
					<div class="authentication-header">
						<a href="<?=$facebook_url?>" id="facebook_login_button_old">
							<span></span>
						</a>
					</div>
					...
					<div class="auth_can">
						...
						<a href="<?=$twitter_url?>" id="provider_twitter_link">
...
<script type="text/javascript">
	<? 
	if($this->input->get('redirect_url',true)){
		$url = $this->input->get('redirect_url',true);
	}else{
		$url = '/';
	}
	?>	
	var url_set = {
			'OKredirectUrl': '<?=$url?>',
			'redirectUrl': '<?='/index.php/signup?redirect_url='.$this->input->get('redirect_url',true)?>'
	};
</script>
