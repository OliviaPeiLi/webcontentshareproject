...
<body style="background-color: #FAFAFA; width: 100%; margin: 0;">
	...
	<table width="100%" cellpadding="10">
		...
		<td colspan="2"><a href="<?=Url_helper::base_url();?>"><font face="lucida grande, helvetica, arial, sans-serif" size="6" color="#313232"><strong><img src="http://www.fandrop.com/images/fandropHeaderLogo_new.png" alt="Fandrop" title="Go To Fandrop" border="0" height="51" style="display: block;"/></strong></font></a></td>
	    </tr> 
	    <tr>
		<td>
			...
			<tr>
			    <td></td>
			    <td>
					<?=$username;?>, found a drop that may be interesting for you
				</td>
			</tr>
			<?php if ($message != "") : ?>
			<tr>
			...
			<tr>
				...
				<table width="320" bgcolor="#F0F0F0" style="color: #656565;font: 12px 'lucida grande',tahoma,helvetica,arial,sans-serif;">
				    <tr>
					<td>
					    <a href="<?=$newsfeed_url;?>"><img src="<?=$image;?>" height="35"></a>
					</td>
					<td>
			    	    <a href="<?=$newsfeed_url;?>" style="color: #3366CC; text-decoration: none; font-weight: bold;"><?=$newsfeed_title;?></a>
					</td>
				    </tr>
				</table>
			    </td>
