...
--
-- Host: localhost
-- Generation Time: Mar 13, 2012 at 05:59 PM
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=106516 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7650 ;
...
CREATE TABLE IF NOT EXISTS `folder` (
  ...
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2259 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5814 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5587 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=5531 ;
...
CREATE TABLE IF NOT EXISTS `newsfeed_activity` (
  ...
  `time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`aid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9171 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3468 ;
...
CREATE TABLE IF NOT EXISTS `pages` (
  ...
  PRIMARY KEY (`page_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=4031 ;
...
CREATE TABLE IF NOT EXISTS `page_users` (
  ...
  KEY `user_id` (`user_id`),
  KEY `page_id` (`page_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=7071 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2958 ;
