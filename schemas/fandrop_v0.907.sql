...
--
-- Host: localhost
-- Generation Time: May 29, 2012 at 10:20 AM
...
CREATE TABLE IF NOT EXISTS `activities` (
  ...
  KEY `type` (`type`),
  KEY `time` (`time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=13112 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9275 ;
...
CREATE TABLE IF NOT EXISTS `folder_user` (
  ...
  KEY `user_id` (`user_id`),
  KEY `folder_id` (`folder_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3269 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=10684 ;
...
CREATE TABLE IF NOT EXISTS `newsfeed` (
  ...
  KEY `folder_id` (`folder_id`),
  KEY `time` (`time`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12011 ;
...
CREATE TABLE IF NOT EXISTS `notifications` (
  ...
  KEY `a_id` (`a_id`),
  KEY `m_id` (`m_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1740 ;
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=6702 ;
