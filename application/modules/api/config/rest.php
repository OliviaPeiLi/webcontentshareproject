...
|
*/
$config['auth_override_class_method']['api']['index_get'] = 'none';
$config['auth_override_class_method']['auth']['index_post'] = 'none';
$config['auth_override_class_method']['auth']['register_post'] = 'none';
$config['auth_override_class_method']['search']['index_get'] = 'none';
$config['auth_override_class_method']['newsfeed']['index_get'] = 'none';
$config['auth_override_class_method']['newsfeed']['item_get'] = 'whitelist';
$config['auth_override_class_method']['folder']['popular_get'] = 'none';
$config['auth_override_class_method']['folder']['index_get'] = 'none';
$config['auth_override_class_method']['folder']['item_get'] = 'none';
$config['auth_override_class_method']['folder']['hashtags_get'] = 'none';
$config['auth_override_class_method']['user']['item_get'] = 'none';
$config['auth_override_class_method']['top_hashtags']['index_get'] = 'none';
// $config['auth_override_class_method']['deals']['insert'] = 'digest';
// $config['auth_override_class_method']['accounts']['user'] = 'basic';
...
|
*/
$config['rest_ip_whitelist'] = '5.9.50.78';
